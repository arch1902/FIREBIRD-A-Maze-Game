...
class Map {
 ...
 public:
  Map(SDL_Renderer *renderer, const ImageManager *image_manager) 
  ...
  inline map_state check_state(const Point &p) const  {
  ...
  inline unsigned int get_home_distance(const Point &p) const  {
